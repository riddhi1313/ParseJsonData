...
public class UserForm extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText etfName,etlname,etTwitter;
    Button btnPost;
...
//        }
    ...
    public static String POST(String url, User user){
        ...
        try {
            ...
            jsonObject.accumulate("first_name", user.getFname());
            jsonObject.accumulate("last_name", user.getLname());
...
//    }
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            case R.id.btnPost:
                ...
                new HttpAsyncTask().execute("https://reqres.in/api/users");
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            //user.setTwitter(etTwitter.getText().toString());
